...
function [count,count_s,count_n,count1,count2,count3] = LeNet5_ConvNet_ensemble5(mnist,k11,B11,k21,B21,W1,B31,W21,B41,k12,B12,k22,B22,W2,B32,W22,B42,k13,B13,k23,B23,W3,B33,W23,B43)
    TEST = mnist.test;
    ...
    for j = 1:10000
        ...
        S23 = max_pooling(C23);
        f3 = vctz_concat(S23);
        y_fc13 = Relu(W3*f3 + B33);
        y_hat3 = logsig(W23*y_fc13 + B43);
        [v3 ii3] = max(y_hat3);
